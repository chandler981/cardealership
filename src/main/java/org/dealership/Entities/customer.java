...
public class Customer{
    /*
     * This class has methods that can be utilized to store 
     * specific information that can be used throughout the whole
     * system by storing it in static variables.
     */
