...
public class InvoiceDAO {
    ...
    public void saveInvoice(Invoice inv) {
        ...
        String insertNewInvoice = "INSERT INTO <Table Name> (<attribute1>, <attribute2>, <attribute3> ) VALUES (inv.getCustAddress(), inv.getFees(), inv.getCustID(), inv.getDiscountTotal(), inv.getPaymentTotal(), inv.getPaymentType(), inv.getPurchaseDate() )";
