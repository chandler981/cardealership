 ...
 * 
 * This file is the controller class that handles putting information
 * into the table that corresponds to a customer or employee searching 
 * the database for a specific vehicle
 *  
 * % java driverClass
 */
