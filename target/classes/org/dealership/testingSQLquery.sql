...
create table employee(
    ...
    dateOfBirth DATE,
    isManager BOOLEAN,
    bankNumber VARCHAR(9)
);

--@block
insert into employee(employeeID, employeePassword, firstName, lastName, employeeAddress, SSN, phoneNumber, dateOfBirth, isManager, bankNumber)
VALUES
    ('1001', 'pass123', 'John', 'Doe', '123 Main St, Cityville', '123-45-6789', '555-1234', '1990-05-15', TRUE, '123456789'),
    ('1002', 'secret456', 'Jane', 'Smith', '456 Oak St, Townsville', '987-65-4321', '555-5678', '1985-09-22', FALSE, '987654321'),
    ('1003', 'pwd789', 'Bob', 'Johnson', '789 Pine St, Villagetown', '543-21-8765', '555-9876', '1995-02-10', FALSE, '555111888');
